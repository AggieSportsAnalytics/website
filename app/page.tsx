...
<div className="w-full h-px bg-zinc-800" />
			...
			<div className=" mt-20 mb-4 drop-shadow-glow px-4 bottom-2 z-20 text-4xl leading-[3rem] duration-1000 bg-gradient-to-r from-20% bg-clip-text text-transparent from-purple-400 to-blue-400 cursor-default  font-display sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:leading-[6.5rem] whitespace-nowrap  ">
