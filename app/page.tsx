...
<div className="w-full h-px bg-zinc-800" />
			...
			<h1 className=" mt-20 mb-4 drop-shadow-glow px-4 bottom-2 z-20 text-4xl  duration-1000 bg-gradient-to-r from-20% bg-clip-text text-transparent from-purple-400 to-blue-400 cursor-default  font-display sm:text-5xl sm:leading-tight md:text-8xl whitespace-nowrap  ">
