		...
		<div className="relative">
			...
			<div className="px-6 pt-16 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
				<div className="mx-auto lg:mx-0">
					...
					Our journalism team aims to write articles highlighting and analyzing contemporary sports topics. Other articles provide thorough background on the development processes of our technical projects.
					</p>
				</div>
