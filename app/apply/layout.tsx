...
export const metadata: Metadata = {
	title: {
		default: "Apply | Aggie Sports Analytics at UC Davis",
...
export default function AboutLayout({
	...
	return (
		<div className="relative min-h-screen bg-gradient-to-tr  from-zinc-950 from-20% via-blue-950 via-30% to-zinc-950 to-50%">
			{children}
		</div>
	);
}
